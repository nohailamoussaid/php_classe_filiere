...
if (isset($_POST['btn_submit'])) {
   if ($_POST['email'] != '' && $_POST['password'] != '') {
        ...
        if ($em->getPassword() == md5($_POST['password'])) {
           ...
           header('Location:./index.php?error=classe');
        }
        else{
            ...
            <div class="page-content--bge5" >
                <div class="container" >
                    <div class="login-wrap">
                        <div class="login-content" style="border-radius: 20px 40px ;border-width: thick;border-style: solid ;width:800px;height: 400px">
                            <div class="login-logo" >
                                <a href="./">
                                    <h1 class="h2 text-dark" style="font-weight: bold;font-size: 40px;">ENSAJ</h1>
                                </a>
                            </div>
